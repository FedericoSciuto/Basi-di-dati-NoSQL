...
for(var y = 0; y < 31; y ++) {
  ...
  MongoClient.connect(url, function(err, db) {
    ...
    fs.appendFile('Query1-50.txt', mia, (err) => {
      if (err) throw err;
    });
  });
}
...
for(var y = 0; y < 31; y ++) {
  ...
  MongoClient.connect(url, function(err, db) {
    ...
    fs.appendFile('Query2-50.txt', mia, (err) => {
      if (err) throw err;
    });
  });
}
...
for(var y = 0; y < 31; y ++) {
  ...
  MongoClient.connect(url, function(err, db) {
    ...
    fs.appendFile('Query3-50.txt', mia, (err) => {
      if (err) throw err;
    });
  });
}
...
for(var y = 0; y < 31; y ++) {
  ...
  MongoClient.connect(url, function(err, db) {
    ...
    fs.appendFile('Query4-50.txt', mia, (err) => {
      if (err) throw err;
    });
  });
}
...
for(var y = 0; y < 31; y ++) {
  ...
  MongoClient.connect(url, function(err, db) {
    ...
    fs.appendFile('Query5-50.txt', mia, (err) => {
      if (err) throw err;
    });
  });
}
...
for(var y = 0; y < 31; y ++) {
  ...
  MongoClient.connect(url, function(err, db) {
    ...
    fs.appendFile('Query1-75.txt', mia, (err) => {
      if (err) throw err;
    });
  });
}
...
for(var y = 0; y < 31; y ++) {
  ...
  MongoClient.connect(url, function(err, db) {
    ...
    fs.appendFile('Query2-75.txt', mia, (err) => {
      if (err) throw err;
    });
  });
}
...
for(var y = 0; y < 31; y ++) {
  ...
  MongoClient.connect(url, function(err, db) {
    ...
    fs.appendFile('Query3-75.txt', mia, (err) => {
      if (err) throw err;
    });
  });
}
...
for(var y = 0; y < 31; y ++) {
  ...
  MongoClient.connect(url, function(err, db) {
    ...
    fs.appendFile('Query4-75.txt', mia, (err) => {
      if (err) throw err;
    });
  });
}
...
for(var y = 0; y < 31; y ++) {
  ...
  MongoClient.connect(url, function(err, db) {
    ...
    fs.appendFile('Query5-75.txt', mia, (err) => {
      if (err) throw err;
    });
  });
}
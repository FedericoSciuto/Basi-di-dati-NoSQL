...
fs.writeFile('people100.json', JSON.stringify(dataObj, null, '\t'), function(err, result) {
...
fs.writeFile('calls100.json', JSON.stringify(dataObj2, null, '\t'), function(err, result) {
    if(err) console.log('error', err);
    else console.log('File saved');
});